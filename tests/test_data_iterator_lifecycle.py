...
class DataIteratorLifecycleTest(unittest.TestCase):
    def test_normal_iterator_exhaustion_is_not_a_data_error(self) -> None:
        ...
        self.assertTrue(PackedDataset._is_dataset_exhaustion(RuntimeError("generator raised StopIteration")))
        self.assertFalse(PackedDataset._is_dataset_exhaustion(RuntimeError("decode failed")))
