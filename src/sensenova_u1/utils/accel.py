...
Production SFT, RL, and serving require accelerators. CPU remains useful for
configuration and checkpoint probes. Targets PyTorch >= 2.5 where
``torch.xpu`` is in-tree.
"""
