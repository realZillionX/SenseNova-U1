    ...
    def forward_und(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if (
            ...
            append = getattr(layer, "commit_flash_decode", None)
            if k_cache is not None and v_cache is not None and callable(append):
                ...
                attn_output = flash_attn_with_kvcache(
                    ...
                    k=k,
                    v=v,
                    cache_seqlens=int(layer.get_seq_length()),
                    softmax_scale=self.scaling,
                    causal=False,
                )
                append(int(k.shape[1]))
