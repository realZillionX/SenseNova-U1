...
class NaiveAMPModel(nn.Module):
    ...
    Args:
        ...
        parallel_mode (:class:`sensenovalm.core.context.ParallelMode`): The parallel group mode used in this module.
    ...
    def _register_fp32_parameters_hook(self) -> None:
        ...
        def to_dtype(x, dtype=fp32_dtype):
            if isinstance(x, Tensor) and x.dtype != dtype and x.dtype != torch.bool:
                return x.to(dtype)
            return x
