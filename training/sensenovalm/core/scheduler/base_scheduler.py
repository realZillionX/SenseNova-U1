...
class BaseScheduler(ABC):
    ...
    @staticmethod
    def _call_engine_criterion(
        engine: Engine, outputs: Any, labels: Any, loss_weight=None, loss_reduction_all_gather=False
    ):
        ...
        if isinstance(outputs, (tuple, list)) and isinstance(labels, (tuple, list)):
            return engine.criterion(
                *outputs, *labels, loss_weight=loss_weight, loss_reduction_all_gather=loss_reduction_all_gather
            )
