...
# Derived from InternEvo (OpenGVLab, Apache-2.0); Timer interface follows
# Megatron-LM (NVIDIA Corporation).
# Upstream reference: https://github.com/NVIDIA/Megatron-LM
# -*- encoding: utf-8 -*-
...
class _Timer:
    ...
    def __init__(self, name):
        ...
        self.stream = sensenovalm_accelerator.current_stream()
...
class Timers:
    ...
    def log(self, names, logger, rank=0, normalizer=1.0, reset=True):
