...
# Derived from InternEvo (OpenGVLab, Apache-2.0). The Timeout class is
# adapted from https://github.com/reasoning-machines/pal (MIT).
import datetime
import os
import signal
import socket
...
ENABLE_TIMEOUT = os.getenv("SENSENOVALM_ENABLE_TIMEOUT", None)
