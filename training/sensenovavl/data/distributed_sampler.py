...
# DistributedSampler interface mirrors `torch.utils.data.distributed.DistributedSampler`
# (PyTorch, BSD-3-Clause); replay/consumption-tracking extensions are original.
import math
