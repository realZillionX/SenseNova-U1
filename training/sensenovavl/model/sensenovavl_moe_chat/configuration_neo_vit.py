...
class NEOVisionConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`NEOVisionModel`]. It is used to
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.moe_layer_kwargs = moe_layer_kwargs
        self.gradient_checkpointing = gradient_checkpointing
        self.checkpoint_per_layer_num = checkpoint_per_layer_num
