...
export MOVA_LIGHTLLM_COMMIT=${MOVA_LIGHTLLM_COMMIT:-5fcda97af5ec11c42dfe1012fb761388e63875a4}
export MOVA_LIGHTX2V_COMMIT=${MOVA_LIGHTX2V_COMMIT:-235a16b773c53774c25eeecf6363d7150a2754c4}
