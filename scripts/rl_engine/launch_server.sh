...
export MOVA_LIGHTLLM_COMMIT=${MOVA_LIGHTLLM_COMMIT:-307ec195c1f5ce4779d56eae37a072b15294cfdb}
export MOVA_LIGHTX2V_COMMIT=${MOVA_LIGHTX2V_COMMIT:-f4aa8833ef0f6d8c256612df769896b6c8e04dd9}
