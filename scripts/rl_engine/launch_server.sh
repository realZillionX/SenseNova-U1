...
export MOVA_IMAGE_DIGEST=${MOVA_IMAGE_DIGEST:-platform-parent-unverified}
export MOVA_SENSENOVA_COMMIT=${MOVA_SENSENOVA_COMMIT:-34ca2f66e7006489a0184eb8896a75f4081a0257}
export MOVA_LIGHTLLM_COMMIT=${MOVA_LIGHTLLM_COMMIT:-1d6803d7414213186b52f85930e91377c286fd99}
export MOVA_LIGHTX2V_COMMIT=${MOVA_LIGHTX2V_COMMIT:-f05032c3c1036449d425b27cd854f1c2a398747f}
...
python "$SOURCE_ROOT/scripts/rl_engine/preflight.py" \
